...
type Note struct {
	...
	PublicId string                 `form:"publicId" json:"publicId" gorm:"type:text"`
	Title    string                 `form:"title" json:"title"`
	Text     string                 `form:"text" json:"text"`
	Owner    string                 `form:"owner" json:"owner"`
	Created  time.Time              `form:"created" json:"created" gorm:"text"`
	Shared   bool                   `form:"shared" json:"shared"`
	Users    []string `form:"users" json:"users" gorm:"type:text"`
	gorm.Model
}
